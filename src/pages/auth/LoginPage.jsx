...
const LoginPage = () => {
  ...
  return (
    <>
      <div className="auth-wrapper rounded-md space-y-6 bg-secondary text-white px-12 py-20">
        <div className="">
        ...
        <form className="space-y-4" action="">
          <div className="flex flex-col gap-2">
            ...
            <input
              className="border border-gray-200 py-2 px-8 outline-0 focus:border-primary transition duration-150 rounded"
              type="email"
            />
          </div>
          <div className="flex flex-col gap-2">
          ...
          <button className="bg-primary w-full py-3 rounded cursor-pointer hover:opacity-85 mt-4">
            Sign In
          </button>
        </form>
