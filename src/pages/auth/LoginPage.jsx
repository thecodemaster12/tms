...
import Input from "../../components/ui/InputGroup";
    ...
    <>
      <div className="auth-wrapper">
        ...
        <form className="space-y-4" action="">
          ...
          <InputGroup type="password" label="Password" placeholder="Enter your password" icon={<HugeiconsIcon icon={CirclePasswordIcon} size={20} />} />

          <button className="bg-primary text-white w-full py-3 rounded cursor-pointer hover:opacity-85 mt-4">
            Sign In
          </button>
        </form>
